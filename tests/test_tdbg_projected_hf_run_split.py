...
def test_tdbg_projected_hf_run_split_preserves_legacy_facade() -> None:
    ...
    assert tdbg_hf.build_tdbg_projected_hf_state is projected_hf_run.build_tdbg_projected_hf_state
    assert tdbg_hf.build_tdbg_projected_hf_kernel is projected_hf_run.build_tdbg_projected_hf_kernel
    assert tdbg_hf.build_tdbg_projected_hf_problem is projected_hf_run.build_tdbg_projected_hf_problem
    assert tdbg_hf.run_tdbg_projected_hf is projected_hf_run.run_tdbg_projected_hf

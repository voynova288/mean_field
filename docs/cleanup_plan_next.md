...
- Bands wrappers remain. Thin TMBG and TDBG topology wrappers are restored; other concrete topology system wrappers and paper workflows are archived, while the tracked surface includes the common FHS/QGT topology core and generic wavefunction/system adapters under `src/analysis/topology`.

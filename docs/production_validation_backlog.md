...
- topology/Chern/QGT paper-level validation beyond the common system-independent core and thin TMBG/TDBG/ATMG/RLG-hBN wrappers; reintroduce reviewed concrete workflows for each target system before claiming system or paper reproduction.

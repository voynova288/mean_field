...
- topology/Chern/QGT paper-level validation beyond the common system-independent core and thin TMBG wrapper; reintroduce reviewed concrete wrappers/workflows for each target system before claiming system or paper reproduction.

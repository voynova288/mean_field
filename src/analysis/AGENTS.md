...
- The old `shift_current_htg/` and `shift_current_tbg/` analysis workspaces have been retired. Put hTG/TBG system adapters under `mean_field.systems`, reusable math under `shift_current/` or `response_derivative_gauge.py`, and historical paper audits under `docs/shift_current/`.

...
def build_khalaf_fig3_path(model: "ATMGModel", points_per_segment: int) -> KPath:
    """Return the Khalaf et al. Fig. 3 ATMG path.

    This is a reusable system-owned path convention.  Historical paper-panel
    plotting lived in a devtool; the durable helper belongs with ATMG bands.
    """

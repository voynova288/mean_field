...
def compute_topology_from_grid_result(
    ...
    *,
    ...
    if grid_result.eigenvectors is None:
        raise ValueError("Grid eigenvectors are required for topology. Recompute the grid with return_eigenvectors=True.")
...
def compute_topology_on_grid(
    ...
    *,
    ...
    for trial_mesh, frac_shift in attempts:
        ...
        try:
            return _topology_from_grid_result(grid_result, normalized_bands, valley=valley)

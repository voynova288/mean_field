...
def compute_topology_from_eigenvectors(
    ...
    *,
    ...
    return compute_system_topology_from_eigenvectors(
        eigenvectors, band_indices, system="tmbg", valley=valley, k_grid_frac=k_grid_frac, orientation_sign=orientation_sign
    )
...
def compute_topology_from_grid_result(
    ...
    *,
    ...
    return compute_system_topology_from_grid_result(
        grid_result, band_indices, system="tmbg", valley=valley, orientation_sign=orientation_sign
    )

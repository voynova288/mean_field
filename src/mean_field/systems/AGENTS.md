...
- Minimal common topology APIs: `../../analysis/topology` (`core.py`, `wavefunction.py`, `system.py`); archived concrete system topology wrappers/QGT reference, if explicitly needed: `../../../local_archive/retired_surface/topology_untracked_20260622/`.
...
- Concrete topology/Berry-geometry system wrappers are not tracked in the minimal public surface. Use `../../analysis/topology` for system-independent FHS link/plaquette/Chern calculations, wavefunction-grid canonicalization, and thin metadata packaging on already-built eigenvector grids; reintroduce concrete system wrappers only through a small reviewed API instead of restoring all historical wrappers.

...
- Minimal common FHS topology core: `../../analysis/topology`; archived system topology wrappers/QGT reference, if explicitly needed: `../../../local_archive/retired_surface/topology_untracked_20260622/`.

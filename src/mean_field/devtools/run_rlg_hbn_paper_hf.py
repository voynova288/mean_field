...
def main() -> None:
    raise SystemExit(
        "run_rlg_hbn_paper_hf was retired from the tracked command surface. "
        "Consult local_archive/retired_surface/ff38584_rlg_hbn_paper_hf_devtool/ or git history if needed."
    )
...
__all__ = [
    ...
    "_load_archive_density",
    "_parse_run_specs",
    "_preflight_run_specs",
    "_save_state_archive",
    "_serialize_run_specs",

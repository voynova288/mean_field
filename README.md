...
- `analysis.topology`: minimal system-independent FHS link/plaquette/Chern helpers, wavefunction-grid canonicalization helpers, and a small system-facing adapter for already-built eigenvector grids. Concrete system topology wrappers and QGT/quantum-metric helpers remain archived under `local_archive/retired_surface/topology_untracked_20260622/` until reviewed separately.
